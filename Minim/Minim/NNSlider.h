...
@property (nonatomic) float segmentLineWidth;
@property (nonatomic) float segmentLineSize;;
@property (nonatomic) float segmentLineOffset;
...
@property (nonatomic) BOOL snapsToSegments;
